...
public interface personaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link personaLocalServiceUtil} to access the persona local service. Add custom service methods to <code>com.liferay.serviceBuilderVASS.service.impl.personaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public List<persona> consumeServiceRestDos(
	...
	public persona createpersona(long cedulaUser);
	...
	public persona deletepersona(long cedulaUser) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public persona fetchpersona(long cedulaUser);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public persona getpersona(long cedulaUser) throws PortalException;
