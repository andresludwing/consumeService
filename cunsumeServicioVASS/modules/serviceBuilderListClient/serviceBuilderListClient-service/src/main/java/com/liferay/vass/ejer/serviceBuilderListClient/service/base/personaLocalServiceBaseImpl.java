...
package com.liferay.vass.ejer.serviceBuilderListClient.service.base;
...
import com.liferay.vass.ejer.serviceBuilderListClient.service.personaLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.vass.ejer.serviceBuilderListClient.service.impl.personaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.vass.ejer.serviceBuilderListClient.service.impl.personaLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class personaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements personaLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>personaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.vass.ejer.serviceBuilderListClient.service.personaLocalServiceUtil</code>.
	 */
	...
	public persona createpersona(int customerId) {
		return personaPersistence.create(customerId);
	}
	...
	public persona deletepersona(int customerId) throws PortalException {
		return personaPersistence.remove(customerId);
	}
	...
	public persona fetchpersona(int customerId) {
		return personaPersistence.fetchByPrimaryKey(customerId);
	}
	...
	public persona getpersona(int customerId) throws PortalException {
		return personaPersistence.findByPrimaryKey(customerId);
	}
