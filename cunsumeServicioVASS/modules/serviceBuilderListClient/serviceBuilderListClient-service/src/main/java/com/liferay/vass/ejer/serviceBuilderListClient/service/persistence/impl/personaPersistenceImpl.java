...
package com.liferay.vass.ejer.serviceBuilderListClient.service.persistence.impl;
...
import com.liferay.vass.ejer.serviceBuilderListClient.model.impl.personaImpl;
import com.liferay.vass.ejer.serviceBuilderListClient.model.impl.personaModelImpl;
import com.liferay.vass.ejer.serviceBuilderListClient.model.persona;
import com.liferay.vass.ejer.serviceBuilderListClient.service.persistence.impl.constants.VASSPersistenceConstants;
import com.liferay.vass.ejer.serviceBuilderListClient.service.persistence.personaPersistence;
...
public class personaPersistenceImpl
	...
	public persona[] findByUuid_PrevAndNext(
		...
		persona persona = findByPrimaryKey(customerId);
	...
	public persona create(int customerId) {
		...
		persona.setNew(true);
		persona.setPrimaryKey(customerId);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.vass.ejer.serviceBuilderListClient.model.persona"),
			true);
	}
