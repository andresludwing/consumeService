...
public interface personaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link personaLocalServiceUtil} to access the persona local service. Add custom service methods to <code>com.liferay.vass.ejer.serviceBuilderListClient.service.impl.personaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public persona createpersona(int customerId);
	...
	public persona deletepersona(int customerId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public persona fetchpersona(int customerId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public persona getpersona(int customerId) throws PortalException;
